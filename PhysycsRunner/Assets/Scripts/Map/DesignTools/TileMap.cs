 namespace CBX.TileMapping.Unity
{
    ...
    {
        public LocationPallete Pallete;
        /// <summary>
        ...
        private void OnDrawGizmosSelected()
        {
            ...
            Gizmos.DrawWireCube(new Vector3(this.MarkerPosition.x,0, this.MarkerPosition.y), new Vector3(this.TileWidth,1,this.TileHeight) * 1.1f);
        }
    }
}